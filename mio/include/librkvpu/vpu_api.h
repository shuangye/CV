...
typedef int   (*MjpegDecoderInit_func)(void* decoder,int w, int h);
typedef int   (*MjpegDecoderDinit_func)(void * Decoder);
typedef int   (*MjpegDecoderDcode_func)(void* Decoder,unsigned char* src, unsigned int len, unsigned char* dst);




typedef struct DS_MjpegDecoder_t DS_MjpegDecoder;

struct DS_MjpegDecoder_t{

    int                     width;
    int                     high;
    VpuCodecContext_t       *vpuctx;
    VPU_FRAME               vpumem;
    MjpegDecoderInit_func   init;
    MjpegDecoderDinit_func  dinit;
    MjpegDecoderDcode_func  decode;
